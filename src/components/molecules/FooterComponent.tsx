  ...
  return (
    <div>
      <div className="flex items-start justify-around bg-slate-100 py-10">
        ...
        <div>
          <p className="mt-4 text-base font-bold lg:text-base">Social</p>
          <div className="mt-3">
      ...
      <div className="flex items-start justify-center border-t-2 bg-slate-100 py-7">
        <p className="text-sm lg:text-base">
          <span className="font-bold text-logoColorBlue">Visa App</span> ©
